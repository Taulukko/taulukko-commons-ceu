...
/**
 * Collection of (typed) CQL values that can be retrieved by index (starting at
 * zero).
 */
public interface GettableByIndexData {
	 ...
	 *
	 * @param i
	 *            the index ({@code 0 <= i < size()}) of the value to check.
	 ...
	 * @return the boolean value of the {@code i}th element. If the value is
	 *         NULL, {@code false} is returned. If you need to distinguish NULL
	 *         and false values, check first with {@link #isNull(int)} or use
	 *         {@code get(i, Boolean.class)}.
	 * @throws IndexOutOfBoundsException
	 *             if {@code i} is not a valid index for this object.
	 ...
	 * @param i
	 *            the index ({@code 0 <= i < size()}) to retrieve.
	 * @return the value of the {@code i}th element as a byte. If the value is
	 *         NULL, {@code 0} is returned. If you need to distinguish NULL and
	 *         0, check first with {@link #isNull(int)} or use
	 *         {@code get(i, Byte.class)}.
	 * @throws IndexOutOfBoundsException
	 *             if {@code i} is not a valid index for this object.
	 * @throws CodecNotFoundException
	 *             if there is no registered codec to convert the element's CQL
	 ...
	 * @param i
	 *            the index ({@code 0 <= i < size()}) to retrieve.
	 * @return the value of the {@code i}th element as a short. If the value is
	 *         NULL, {@code 0} is returned. If you need to distinguish NULL and
	 *         0, check first with {@link #isNull(int)} or use
	 *         {@code get(i, Short.class)}.
	 * @throws IndexOutOfBoundsException
	 *             if {@code i} is not a valid index for this object.
	 * @throws CodecNotFoundException
	 *             if there is no registered codec to convert the element's CQL
	 ...
	 * @param i
	 *            the index ({@code 0 <= i < size()}) to retrieve.
	 * @return the value of the {@code i}th element as an integer. If the value
	 *         is NULL, {@code 0} is returned. If you need to distinguish NULL
	 *         and 0, check first with {@link #isNull(int)} or use
	 *         {@code get(i, Integer.class)}.
	 * @throws IndexOutOfBoundsException
	 *             if {@code i} is not a valid index for this object.
	 * @throws CodecNotFoundException
	 *             if there is no registered codec to convert the element's CQL
	 ...
	 * @param i
	 *            the index ({@code 0 <= i < size()}) to retrieve.
	 * @return the value of the {@code i}th element as a long. If the value is
	 *         NULL, {@code 0L} is returned. If you need to distinguish NULL and
	 *         0L, check first with {@link #isNull(int)} or use
	 *         {@code get(i, Long.class)}.
	 * @throws IndexOutOfBoundsException
	 *             if {@code i} is not a valid index for this object.
	 * @throws CodecNotFoundException
	 *             if there is no registered codec to convert the element's CQL
	 ...
	 * @param i
	 *            the index ({@code 0 <= i < size()}) to retrieve.
	 * @return the value of the {@code i}th element as a data. If the value is
	 ...
	 * @param i
	 *            the index ({@code 0 <= i < size()}) to retrieve.
	 * @return the value of the {@code i}th element as an date. If the value is
	 *         NULL, {@code null} is returned.
	 * @throws IndexOutOfBoundsException
	 *             if {@code i} is not a valid index for this object.
	 * @throws CodecNotFoundException
	 ...
	 * @param i
	 *            the index ({@code 0 <= i < size()}) to retrieve.
	 * @return the value of the {@code i}th element as a float. If the value is
	 *         NULL, {@code 0.0f} is returned. If you need to distinguish NULL
	 *         and 0.0f, check first with {@link #isNull(int)} or use
	 *         {@code get(i, Float.class)}.
	 * @throws IndexOutOfBoundsException
	 *             if {@code i} is not a valid index for this object.
	 * @throws CodecNotFoundException
	 *             if there is no registered codec to convert the element's CQL
	 ...
	 * @param i
	 *            the index ({@code 0 <= i < size()}) to retrieve.
	 * @return the value of the {@code i}th element as a double. If the value is
	 *         NULL, {@code 0.0} is returned. If you need to distinguish NULL
	 *         and 0.0, check first with {@link #isNull(int)} or use
	 *         {@code get(i, Double.class)}.
	 * @throws IndexOutOfBoundsException
	 *             if {@code i} is not a valid index for this object.
	 * @throws CodecNotFoundException
	 *             if there is no registered codec to convert the element's CQL
	 ...
	 * @param i
	 *            the index ({@code 0 <= i < size()}) to retrieve.
	 * @return the value of the {@code i}th element as a string. If the value is
	 *         NULL, {@code null} is returned.
	 * @throws IndexOutOfBoundsException
	 *             if {@code i} is not a valid index for this object.
	 * @throws CodecNotFoundException
	 ...
	 * @param i
	 *            the index ({@code 0 <= i < size()}) to retrieve.
	 * @return the value of the {@code i}th element as a variable length
	 *         integer. If the value is NULL, {@code null} is returned.
	 * @throws IndexOutOfBoundsException
	 *             if {@code i} is not a valid index for this object.
	 * @throws CodecNotFoundException
	 *             if there is no registered codec to convert the element's CQL
	 ...
	 *            the index ({@code 0 <= i < size()}) to retrieve.
	 * @return the value of the {@code i}th element as a variable length
	 *         decimal. If the value is NULL, {@code null} is returned.
	 * @throws IndexOutOfBoundsException
	 *             if {@code i} is not a valid index for this object.
	 * @throws CodecNotFoundException
	 *             if there is no registered codec to convert the element's CQL
	 ...
	 * @param i
	 *            the index ({@code 0 <= i < size()}) to retrieve.
	 * @return the value of the {@code i}th element as a UUID. If the value is
	 *         NULL, {@code null} is returned.
	 * @throws IndexOutOfBoundsException
	 *             if {@code i} is not a valid index for this object.
	 * @throws CodecNotFoundException
	 ...
	 * @param i
	 *            the index ({@code 0 <= i < size()}) to retrieve.
	 * @return the value of the {@code i}th element as an InetAddress. If the
	 *         value is NULL, {@code null} is returned.
	 * @throws IndexOutOfBoundsException
	 *             if {@code i} is not a valid index for this object.
	 * @throws CodecNotFoundException
	 ...
	 * Furthermore, the behavior of this method in respect to CQL {@code NULL}
	 * values is also codec-dependent. By default, the driver will return
	 * mutable instances, and a CQL {@code NULL} will be mapped to an empty
	 * collection (note that Cassandra makes no distinction between {@code NULL}
	 ...
	 * Furthermore, the behavior of this method in respect to CQL {@code NULL}
	 * values is also codec-dependent. By default, the driver will return
	 * mutable instances, and a CQL {@code NULL} will mapped to an empty
	 * collection (note that Cassandra makes no distinction between {@code NULL}
	 * and an empty collection).
	 *
	 * @param i
	 *            the index ({@code 0 <= i < size()}) to retrieve.
	 * @param elementsType
	 *            the type of the elements of the list to retrieve.
	 * @return the value of the {@code i}th element as a list of {@code T}
	 *         objects.
	 * @throws IndexOutOfBoundsException
	 *             if {@code i} is not a valid index for this object.
	 ...
	 * the behavior of this method in respect to CQL {@code NULL} values is also
	 * codec-dependent. By default, the driver will return mutable instances,
	 * and a CQL {@code NULL} will mapped to an empty collection (note that
	 * Cassandra makes no distinction between {@code NULL} and an empty
	 * collection).
	 *
	 * @param i
	 *            the index ({@code 0 <= i < size()}) to retrieve.
	 ...
	 * @return the value of the {@code i}th element as a set of {@code T}
	 *         objects.
	 * @throws IndexOutOfBoundsException
	 *             if {@code i} is not a valid index for this object.
	 * @throws CodecNotFoundException
	 ...
	 *            the index ({@code 0 <= i < size()}) to retrieve.
	 * @param keysClass
	 *            the class for the keys of the map to retrieve.
	 * @param valuesClass
	 *            the class for the values of the map to retrieve.
	 * @return the value of the {@code i}th element as a map of {@code K} to
	 *         {@code V} objects.
	 * @throws IndexOutOfBoundsException
	 *             if {@code i} is not a valid index for this object.
	 * @throws CodecNotFoundException
	 ...
	 * {
	 * 	&#064;code
	 * 	Map&lt;Int, List&lt;String&gt;&gt; l = row.getMap(1, TypeToken.of(Integer.class),
	 ...
	 *            the index ({@code 0 <= i < size()}) to retrieve.
	 * @param keysType
	 *            the type for the keys of the map to retrieve.
	 * @param valuesType
	 ...
	 * @param i
	 *            the index ({@code 0 <= i < size()}) to retrieve.
	 * @return the value of the {@code i}th element as a UDT value. If the value
	 *         is NULL, then {@code null} will be returned.
	 * @throws IndexOutOfBoundsException
	 *             if {@code i} is not a valid index for this object.
	 * @throws CodecNotFoundException
	 *             if there is no registered codec to convert the element's CQL
	 ...
	 * getters, such as the ones for built-in types ({@link #getBool(int)},
	 * {@link #getInt(int)}, etc.), or {@link #get(int, Class)} and
	 * {@link #get(int, TypeToken)} for custom types.
	 *
	 * @param i
	 *            the index to retrieve.
	 * @return the value of the {@code i}th value as the Java type matching its
	 *         CQL type.
	 * @throws IndexOutOfBoundsException
	 *             if {@code i} is not a valid index for this object.
	 ...
	 * thread-safety. Furthermore, the behavior of this method in respect to CQL
	 * {@code NULL} values is also codec-dependent; by default, a CQL
	 * {@code NULL} value translates to {@code null} for simple CQL types, UDTs
	 * and tuples, and to empty collections for all CQL collection types.
	 *
	 * @param i
	 *            the index to retrieve.
	 * @param targetClass
	 *            The Java type the value should be converted to.
	 * @return the value of the {@code i}th value converted to the given Java
	 *         type.
	 * @throws IndexOutOfBoundsException
	 *             if {@code i} is not a valid index for this object.
	 * @throws CodecNotFoundException
	 ...
	 *            the index to retrieve.
	 * @param codec
	 *            The {@link TypeCodec} to use to deserialize the value; may not
	 *            be {@code null}.
	 * @return the value of the {@code i}th value converted using the given
	 *         {@link TypeCodec}.
	 * @throws InvalidTypeException
	 *             if the given codec does not
	 *             {@link TypeCodec#accepts(DataType) accept} the underlying CQL
	 *             type.
	 * @throws IndexOutOfBoundsException
	 *             if {@code i} is not a valid index for this object.
	 */
