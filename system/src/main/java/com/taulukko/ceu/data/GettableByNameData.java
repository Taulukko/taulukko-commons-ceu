...
public interface GettableByNameData {
	 ...
	 *         {@code false} is returned. If you need to distinguish NULL and
	 *         false values, check first with {@link #isNull(String)} or use
	 *         {@code get(name, Boolean.class)}.
	 * @throws IllegalArgumentException
	 *             if {@code name} is not valid name for this object.
	 ...
	 *         {@code 0} is returned. If you need to distinguish NULL and 0,
	 *         check first with {@link #isNull(String)} or use
	 *         {@code get(name, Byte.class)}. {@code 0} is returned.
	 * @throws IllegalArgumentException
	 *             if {@code name} is not valid name for this object.
	 * @throws CodecNotFoundException
	 *             if there is no registered codec to convert the underlying CQL
	 ...
	 *         {@code 0} is returned. If you need to distinguish NULL and 0,
	 *         check first with {@link #isNull(String)} or use
	 *         {@code get(name, Short.class)}. {@code 0} is returned.
	 * @throws IllegalArgumentException
	 *             if {@code name} is not valid name for this object.
	 * @throws CodecNotFoundException
	 *             if there is no registered codec to convert the underlying CQL
	 ...
	 *         {@code 0L} is returned. If you need to distinguish NULL and 0L,
	 *         check first with {@link #isNull(String)} or use
	 *         {@code get(name, Long.class)}.
	 * @throws IllegalArgumentException
	 *             if {@code name} is not valid name for this object.
	 * @throws CodecNotFoundException
	 *             if there is no registered codec to convert the underlying CQL
	 ...
	 *         {@code 0.0f} is returned. If you need to distinguish NULL and
	 *         0.0f, check first with {@link #isNull(String)} or use
	 ...
	 *         {@code 0.0} is returned. If you need to distinguish NULL and 0.0,
	 *         check first with {@link #isNull(String)} or use
	 ...
	 * @param name
	 *            the name to retrieve.
	 * @return the value for {@code name} as a variable length integer. If the
	 ...
	 * @param name
	 *            the name to retrieve.
	 * @return the value for {@code name} as a variable length decimal. If the
	 *         value is NULL, {@code null} is returned.
	 * @throws IllegalArgumentException
	 *             if {@code name} is not valid name for this object.
	 * @throws CodecNotFoundException
	 ...
	 * @param name
	 *            the name to retrieve.
	 * @return the value for {@code name} as a UUID. If the value is NULL,
	 *         {@code null} is returned.
	 * @throws IllegalArgumentException
	 *             if {@code name} is not valid name for this object.
	 * @throws CodecNotFoundException
	 ...
	 * @param name
	 *            the name to retrieve.
	 * @return the value for {@code name} as an InetAddress. If the value is
	 ...
	 * {@link #getMap(String, TypeToken, TypeToken)}.
	 * <p/>
	 ...
	 * @return the value of {@code name} as a map of {@code K} to {@code V}
	 *         objects.
	 * @throws IllegalArgumentException
	 *             if {@code name} is not valid name for this object.
	 * @throws CodecNotFoundException
	 ...
	 * getters, such as the ones for built-in types ({@link #getBool(String)},
	 * {@link #getInt(String)}, etc.), or {@link #get(String, Class)} and
	 * {@link #get(String, TypeToken)} for custom types.
	 *
	 * @param name
	 *            the name to retrieve.
	 * @return the value of {@code name} as the Java type matching its CQL type.
	 *         If the value is NULL and is a simple type, UDT or tuple,
	 *         {@code null} is returned. If it is NULL and is a collection type,
	 *         an empty (immutable) collection is returned.
	 * @throws IllegalArgumentException
	 ...
	 * @return the value for {@code name} value converted to the given Java
	 *         type.
	 * @throws IllegalArgumentException
	 *             if {@code name} is not a valid name for this object.
	 * @throws CodecNotFoundException
